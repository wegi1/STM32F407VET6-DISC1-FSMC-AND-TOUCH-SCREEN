...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LCD_BL_Pin|LCDTP_CS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LCDTP_CLK_GPIO_Port, LCDTP_CLK_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LCDTP_DIN_GPIO_Port, LCDTP_DIN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LCD_BL_Pin LCDTP_CS_Pin */
  GPIO_InitStruct.Pin = LCD_BL_Pin|LCDTP_CS_Pin;
